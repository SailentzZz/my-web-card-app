  ...
  <body>
    ...
    <div class="content-wrap">
      ...
      <div class="content">
                      ...
                      <div class="wrap-about">
                        <table class="w-content">
                          ...
                          <tr>
                            ...
                            <td class="break">:</td>
                            <td> mishatravin99@gmail.com</td>
                          </tr>
                          <tr>
                            <td class="title">Address </td>
                            <td class="break">:</td>
                            <td>Vernadsky Ave. 86 b1, Moscow, Russia</td>
                          </tr>
                          <tr>
        ...
        <div class="scroll"></div><!--/.ABOUT END-->
            ...
            <div class="row">
              ...
              <div class="col-md-9 content-right">
                ...
                <ul class="portfolio-image">           
                  <li class="col-md-6">
                  <form id="form1" action="resume" method="get">
                    <a href="images/bw-1.png" onclick="document.getElementById('form1').submit();"><img alt="image" src="images/bw-1.png">
              ...
              <div class="col-md-9 content-right">
                ...
                <div class="skillst">
                 ...
                 <div class="skillbar" data-percent="83%">
                    <div class="title head-sm">
                      Java EE(Servlets, Jstl, JDBC, Validation)
                    </div>
                    <div class="count-bar">
                      <div class="count"></div>
                    </div>
            ...
            <div class="row">
              ...
              <div class="col-md-9 content-right">
                <form action="message" method="post" accept-charset="UTF-8">                
                  <div class="group">
                    <input required="" name= "FromName" type="text">
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <font color=red>${msgErr.nameErr}</font><br>
                    <label>Name</label>
                  </div>
                  <div class="group">
                    ...
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <font color=red>${msgErr.EmailErr}</font><br>
                    <label>Email</label>
                  </div>
                  <div class="group">
                    ...
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <font color=red>${msgErr.messageErr}</font><br>
                    <label>Message</label>
                  </div>
        ...
        <footer>
          <div class="footer-top">
            <ul class="socials">
              <li class="facebook">
                <a href="https://vk.com/jackblack01" data-hover="VK">VK</a>
              </li>
              <li class="twitter">
